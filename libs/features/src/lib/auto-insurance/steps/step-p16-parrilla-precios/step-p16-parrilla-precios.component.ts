...
import { BalButton, BalCard, BalCardContent, BalCheckbox, BalSelect, BalSelectOption } from '@baloise/ds-angular';
import { InsuranceNavigationService } from '@mnv-autos-clientes/core';
import { GrupoModalidades, InsuranceStateService, Modalidad, P16ModalidadesService, P16ConfiguracionService } from '@mnv-autos-clientes/data';

@Component({
	selector: 'lib-step-p16-parrilla-precios',
	imports: [BalButton, BalCard, BalCardContent, BalCheckbox, BalSelect, BalSelectOption],
...
export class StepP16ParrillaPreciosComponent implements OnInit {
	...
	private readonly configuracionService = inject(P16ConfiguracionService);
	...
	ngOnInit(): void {
		this.configuracionService.cargar();
