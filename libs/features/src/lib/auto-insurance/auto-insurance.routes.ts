...
export const AUTO_INSURANCE_ROUTES: Routes = [
	{
		...
		children: [
			...
			},
			{
				path: 'sin-precio',
				loadComponent: () =>
					import('./steps/step-p16-sin-precio/step-p16-sin-precio.component').then((m) => m.StepP16SinPrecioComponent)
			},
			{
				path: 'contratacion',
				loadComponent: () =>
			...
			{
				path: 'coberturas-opcionales',
				loadComponent: () =>
					import('./steps/step-p18-coberturas-opcionales/step-p18-coberturas-opcionales.component').then(
						(m) => m.Step18CoberturasOpcionales
					),
				canActivate: [insuranceFlowGuard]
			},
			{
				path: 'matricula',
				loadComponent: () =>
					import('./steps/step-p21-matricula/step-p21-matricula.component').then((m) => m.StepP21MatriculaComponent),
				canActivate: [insuranceFlowGuard]
			},
			{
				path: 'segundo-conductor',
				loadComponent: () =>
					import('./steps/step-p24-segundo-conductor/step-p24-segundo-conductor.component').then(
						(m) => m.StepP24SegundoConductorComponent
					),
				canActivate: [insuranceFlowGuard]
			},
			{
				path: 'propietario-conductor',
				loadComponent: () =>
					import('./steps/step-p19-propietario-conductor/step-p19-propietario-conductor.component').then(
						(m) => m.StepP19PropietarioConductorComponent
					),
				canActivate: [insuranceFlowGuard]
			},
			{
				path: 'tomador',
				loadComponent: () =>
					import('./steps/step-p20-tomador/step-p20-tomador.component').then((m) => m.StepP20TomadorComponent),
				canActivate: [insuranceFlowGuard]
			}
		]
	}
